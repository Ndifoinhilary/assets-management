    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_image', models.ImageField(blank=True, help_text='Upload a profile image (JPG, PNG, WebP). Max size: 5MB.', null=True, upload_to=accounts.models.profile_image_path, validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['jpg', 'jpeg', 'png', 'webp']), accounts.utils.validate_profile_image], verbose_name='profile image')),
                ('location', models.CharField(blank=True, help_text='The location of the user, e.g., country or city', max_length=300, null=True, verbose_name='Location')),
                ('city', models.CharField(blank=True, help_text='The city where the user resides', max_length=300, null=True, verbose_name='City')),
        ...
        migrations.AddIndex(
            model_name='user',
            index=models.Index(fields=['otp_code'], name='accounts_us_otp_cod_3d86aa_idx'),
        ),
        migrations.AddIndex(
            model_name='user',
        ...
        migrations.AddIndex(
            model_name='profile',
            index=models.Index(fields=['updated_at'], name='accounts_pr_updated_5f69ca_idx'),
        ),
        migrations.AddIndex(
            model_name='profile',
